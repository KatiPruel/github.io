...
## Deploy
You can test the project from the page [ ](https://github.com/KatiPruel/github.io.git)

## Local Audit
Clone the repository
```
git clone https://01.kood.tech/git/KatiPruel/graphql.git
```
...
## Authors
- [Kati_Pruel] (https://01.kood.tech/git/KatiPruel)